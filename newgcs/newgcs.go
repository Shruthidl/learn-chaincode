...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	function, args := stub.GetFunctionAndParameters() // newly added
...
func (t *SimpleChaincode) addOutClearFile(stub shim.ChaincodeStubInterface, args []string) pb.Response {
  var err error;
  var counter1 int;
...
func (t *SimpleChaincode) addInClearFile(stub shim.ChaincodeStubInterface, args []string) pb.Response {
  var err error;
  var counter2 int;
...
func (t *SimpleChaincode) markTxnCleared(stub shim.ChaincodeStubInterface, args []string) pb.Response {
        var s = args;
...
func (t *SimpleChaincode) markFilesCleared(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	var s = args;
        var mCount int = len(s);
        parts  := make([]string, mCount );
   	parts = s;
...
func (t *SimpleChaincode) getFiles(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *SimpleChaincode) getAlltxns(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *SimpleChaincode) getCurrentFileId(stub shim.ChaincodeStubInterface, args []string) pb.Response {
...
func (t *SimpleChaincode) getCounts(stub shim.ChaincodeStubInterface, args []string) pb.Response {
